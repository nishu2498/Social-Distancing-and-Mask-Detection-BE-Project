    ...
    if len(box_line) > 0:
        ...
        for i in flat_box:
            ...
            if status[index] == True:
                ...
                data1="Social Distancing  Maintained"
                TTS =gTTS(text=data1)
                TTS.save("voice1.mp3")
                time.sleep(1)
...
while(True):
    ...
    current_img = imutils.resize(current_img, width=1000)
    ...
    if(frameno%2 == 0 or frameno == 1):
        ...
        if create is None:
            ...
            create = cv2.VideoWriter(opname, fourcc,  1.0, (1280, 360), True)
    create.write(Frame)
